...
SecuMonitor es un sistema **SIEM (Security Information and Event Management)** desarrollado desde cero como proyecto personal, orientado a la detección de patrones de ataque, gestión de riesgos de seguridad y generación automática de informes. Desplegado en la nube con Firebase y Render.

---

## 🚀 Demo en vivo

> [https://secumonitor.onrender.com](https://secumonitor.onrender.com)  
...
git clone https://github.com/joanmanuelibacache/secumonitor.git
cd secumonitor
